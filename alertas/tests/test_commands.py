...
#
# El parser de BORME-JSONs y generador de alertas podría ser mejor un Job de
# Luigi, que metiera en la BD los valores y luego
#  una función que leyera estos valores. O un parser que creara un archivo
#  intermedio y se pudiera importar en la BD.
"""
class TestCommandNotifications(TestCase):
    # En lugar de comprobar si se ha enviado el email, comprobamos si existe
    # el historial
