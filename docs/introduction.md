En estos momentos hay una versión en producción en [https://librebor.me](https://librebor.me).

# Acerca de LibreBOR

LibreBOR (anteriormente conocida como LibreBORME) es una plataforma web para la consulta y el análisis del Boletín Oficial del Registro Mercantil.

LibreBOR nace en 2014 como un Proyecto de Fin de Carrera con la intención de «abrir» los datos del Registro Mercantil de España. Aprovechando que [desde 2009](https://elpais.com/diario/2008/01/03/ciberpais/1199330666_850215.html)
